...
<main class="sm:ml-72 p-8">
  <div class="max-w-4xl mx-auto bg-white rounded-lg shadow p-8">
    ...
    <div class="mb-6 border-b pb-3">
      <h2 class="text-xl font-bold text-green-800 uppercase tracking-wide">Family Background</h2>
      <p class="text-sm text-gray-500 mt-1">Provide the needed information of the family.</p>
    </div>

...
<main class="sm:ml-72 p-8">
    <div class="max-w-5xl mx-auto bg-white rounded-lg shadow p-8">
      ...
      <!-- Header (no underline) -->
      <div class="mb-6 pb-3">
        <h2 style="font-family: 'Poppins', sans-serif; font-weight: 800; font-size: 1.5rem; color: #14532d; text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 0.25rem;">Civil Service Eligibility</h2>
        <p style="font-family: 'Poppins', sans-serif; font-size: 0.8rem; color: #6b7280;">Provide details regarding civil service eligibility.</p>
      </div>

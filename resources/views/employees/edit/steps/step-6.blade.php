<form method="POST" action="{{ route('employees.edit.step.post', ['id' => $employee->id, 'step' => 6]) }}">
    ...
    <div class="max-w-7xl mx-auto bg-white rounded-lg shadow p-8">
        ...
        <div class="mb-6 border-b pb-4">
            ...
            <p style="font-family: 'Montserrat', sans-serif; font-size: 0.8rem; color: #6b7280;">Update voluntary work details.</p>
        </div>
        ...
        <div class="border border-gray-300 text-xs w-full">
            ...
            <div id="voluntary-list" class="flex flex-col">
                @php
                    $voluntaries = $employee->voluntaryWorks->count()
    ...
    <script>
        let voluntaryIndex = {{ $employee->voluntaryWorks->count() ?: 1 }};
